...
server.listen(PORT, '0.0.0.0', () => {
    ...
    if (PORT === DEV_PORT) {
        ...
        Print.green(`  http://${HOST}/?translations=KJV,NASB,RSV,RUSV,NKJV,ESV,NRSV,NRT&book=Genesis&chapter=3`)
    }
    else if (PORT === HTTPS_PORT) {
        Print.green(`  https://${HOST}/`)
        Print.green(`  https://${HOST}/?translations=KJV,NASB,RSV,RUSV,NKJV,ESV,NRSV,NRT&book=Genesis&chapter=3`)
    }
});