import { ListMap } from "../../../kozubenko/map.extensions.js";
import { Tree } from "../../../kozubenko/tree.js";
import { BIBLE, Book } from "./Bible.js";


const BOOKS_MAP: Map<string, string[]> = new Map([
    // ['1', ['1 SAMUEL', '1 KINGS', '1 CHRONICLES', '1 CORINTHIANS', '1 THESSALONIANS', '1 TIMOTHY', '1 PETER', '1 JOHN']],
    // ['2', ['2 SAMUEL', '2 KINGS', '2 CHRONICLES', '2 CORINTHIANS', '2 THESSALONIANS', '2 TIMOTHY', '2 PETER', '2 JOHN']],
    // ['3', ['3 JOHN']],
...
export class BibleSearch {
    ...
    static match_bible_book_search_term(str:string): Book | null {
        const i = BIBLE_BOOK_SEARCH_TERMS.findIndex(
...
export function BookSearch(search:string): Book|null {
    ...
    console.log(`BookSearch(): search: ${search}`)
