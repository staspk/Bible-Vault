...
# data = ast.literal_eval(set)

# Print.green(data.__len__())



# for translation in translations:
#     identify_chapter(translation, BIBLE.HOSEA, 9)
#     Subprocess.Notepad(File(BIBLE_TXT_NEW, translation, BIBLE.JEREMIAH.name, f'{41}.txt'))
